                ...
                <form action="">
                    <div className="flex flex-col sm:flex-row gap-8 items-center mb-8 ">
                        <div className="sm:w-1/2 w-full">
                            ...
                            <input type="text" name="fName" id="fName" className="block border border-primary 
                            rounded-lg py-2 mt-2 w-full  "/>
                        </div>
                        <div className="sm:w-1/2 w-full">
                            <label htmlFor="LName" className="text-base text-headingColor w-full ">Last name</label>
                            <input type="text" name="LName" id="LName" className="block border border-primary 
                            rounded-lg py-2 mt-2 w-full  "/>                            
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-8 items-center mb-8 ">
                        <div className="sm:w-1/2 w-full">
                            ...
                            <input type="email" name="email" id="email" className="block border border-primary 
                            rounded-lg py-2 mt-2 w-full  "/>
                        </div>
                        <div className="sm:w-1/2 w-full">
                            <label htmlFor="phone" className="text-base text-headingColor w-full ">Phone number</label>
                            <input type="text" name="phone" id="phone" className="block border border-primary 
                            rounded-lg py-2 mt-2 w-full  "/>                            
                        </div>
                    </div>
                    ...
                    <div className="w-full mb-8 ">
                        ...
                        <select name="options" id="options" className="block border border-primary 
                            rounded-lg py-2 mt-2 w-full px-2 ">
                    ...
                    <textarea name="message" id="" cols="30" rows="5" placeholder="Type your message..." 
                    ...
                    <div>
                        ...
                        items-center ">I accept the terms</label>
                    </div>
